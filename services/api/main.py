...
def valuation_chart_run(chart_run_id: str) -> dict:
    try:
        ...
        raise HTTPException(status_code=400, detail="invalid chart run id") from exc
    if record is None:
...
def chart_layouts(request: Request, owner_key: str = "default") -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="invalid chart layout owner") from exc
...
def remove_chart_layout(layout_id: str, request: Request, owner_key: str = "default") -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="invalid chart layout identifier") from exc
    if not removed:
